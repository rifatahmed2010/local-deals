    ...
    <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
        <div class="sb-sidenav-menu">
            <div class="nav">
                ...
                <a class="nav-link" href="{{asset('universities')}}">
                    <div class="sb-nav-link-icon"><i class="fa fa-school"></i></div>
                    University
                </a>
                ...
                <a class="nav-link" href="{{asset('school_requests')}}">
                    <div class="sb-nav-link-icon"><i class="fa fa-school"></i></div>
                    School Request
                </a>
                ...
                <div class="collapse" id="collapseAnalytic" aria-labelledby="headingTwo" data-bs-parent="#analytic">
                    <nav class="sb-sidenav-menu-nested nav accordion" id="analytic">
                        ...
                        <a class="nav-link" href="{{asset('timebased-performance')}}">Time Based Performance Analytic</a>
